...
if __name__ == '__main__':
	...
	plt.subplot(2, 2, 4)
	pl.scatter(np.arange(Y_pre.shape[0]), Y_testsort, c="b", label="original")
	pl.scatter(np.arange(Y_pre.shape[0]), Y_presort, c="r", label="pre function")
	pl.xlabel("X")
	pl.ylabel("Y_pre")
	pl.legend(loc="upper left")
	pl.title("test data")
